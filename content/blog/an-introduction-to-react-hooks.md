...
description: "Hooks are functions that allow the user to 'hook into' different React features. "
excerpt: "Hooks are functions that allow the user to 'hook into' different React features. "
---

![enter image description here](https://i.imgur.com/DorT4NU.jpg)
