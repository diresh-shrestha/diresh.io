---
slug: "/blog/technoogies-im-learning-in-2021"
...
PostgreSQL is a relational database based on SQL. Now my main goal with learning PostgreSQL is to brush up on my SQL and to learn a new database apart from mongodb. Ben Awad has a great [tutorial](https://www.youtube.com/watch?v=tp_5c6jaNQE&ab_channel=BenAwad) on PostgreSQL on his youtube channel, which I will be using.
